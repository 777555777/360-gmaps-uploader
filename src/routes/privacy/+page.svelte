...
<div class="privacy-page">
	...
	<main>
		...
		<p>
			...
			St John&rsquo;s Innovation Centre, Cowley Road, Cambridge, CB4 0WS, Gro&szlig;britannien, ein.
			...
			Europ&auml;ischen Union entspricht. Bei der Nutzung der OpenStreetMap-Karten wird eine
			Verbindung zu den Servern der OpenStreetMap-Foundation hergestellt. Dabei k&ouml;nnen
			u.&nbsp;a. Ihre IP-Adresse und weitere Informationen &uuml;ber Ihr Verhalten auf dieser
			Website an die OSMF weitergeleitet werden. OpenStreetMap speichert hierzu unter Umst&auml;nden
